...
using WealthTrackWebAPP.Models.ViewModel;

namespace WealthTrackWebAPP.Controllers
{
    public class InvestmentsController : Controller
    {
        private readonly WealthTrackWebAPPContext _context;

        public InvestmentsController(WealthTrackWebAPPContext context)
        {
            _context = context;
        }
